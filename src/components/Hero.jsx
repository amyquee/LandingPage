  ...
  return (
    ...
    >
      ...
      >
        ...
        ss:text-[68px] ss-leading-[100px] leading-[75px]
        w-full">Payment Mehod</h1>
      ...
      relative my-10 md:my-0`}>
        <img src={robot} alt="billing" className="w-[100%] h-[100%] 
        relative z-[5]" />
        <div className="absolute top-0 pink__gradient
        z-[0] w-[40%] h-[35%]"></div>
        <div className="absolute z-[1] w-[80%] 
        h-[80%] rounded-full bottom-40 white__gradient"></div>
        <div className="absolute  blue__gradient
        z-[0] w-[50%] h-[50%] bottom-20 right-20"></div>
      </div>
    </section>
  );
};
